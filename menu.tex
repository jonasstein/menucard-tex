...
\end{flushleft}
\end{minipage}%
\hfill\SI{#4}{} \euro\\[0.8mm]}

\titlespacing*{\section}{0pt}{1.5mm}{0mm}
%\titlespacing*{<command>}{<left>}{<before-sep>}{<after-sep>}

%\newcommand{\Phantasiename}[1]{{\sl{\textbf{#1}}}}
\newcommand{\Phantasiename}[1]{{\sl{#1}}}
...
\begin{center}
\includegraphics[width=\textwidth]{gfx/dragon_raw4_ready.jpg}%
